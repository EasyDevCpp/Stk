...
*/
#ifndef _StkCheckLabel
#define _StkCheckLabel
...
public:
    CheckLabel(){}
    CheckLabel(std::string widgetText,int x,int y,int font_mode)
    {
        ...
        init(x,y,text_w,text_h,true,true);
    ...
    void draw()
    {
        ...
        if(getState())
        {
            if(getActive())
            {
                ...
                Base::renderFillRect(Style::active_color,getX(),getY()+text_h+6,text_w,ani_pos);
                getEvent();
            }
            else
            {
                ...
                Base::renderFillRect(Style::hover_color,getX(),getY()+text_h+6,text_w,ani_pos);
            }
        }
    }
